...
import ActivityItem from "./ActivityItem";
 ...
 function RecentActivities() {
  ...
  return (
      <div className="flex h-full  max-h-[650px] flex-col rounded-2xl border border-slate-200 bg-white shadow-sm">
      {/* Header */}
     ...
     <div className="flex-1 scrollbar-none overflow-y-auto px-5">
